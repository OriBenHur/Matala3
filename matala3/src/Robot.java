...
public class Robot{
	...
	private int index;
    private static final int initialDelay = 1000;	// Number of milliseconds delay for new robots
    ...
    private static final Color robotColor = new Color( (float)0.255, (float)0.40, (float)0.255 );
    ...
    public boolean okToMove() {
        Point next = this.nextTile();
        boolean ans = room.isObstructed( next.x, next.y );
